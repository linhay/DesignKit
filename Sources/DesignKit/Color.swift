...
public protocol DColors {}

public extension DColors {
    
    static var bg1: Color { Color("bg1", bundle: .module) }
...
extension Color: DColors {
    
    public enum DLevel10: Int, CaseIterable {
        case d1 = 1, d2, d3, d4, d5, d6, d7, d8, d9, d10
    }
    
    public enum DKind10: String, CaseIterable {
        case red, blue, brown, cyan, green, n, purple, orange
    }
    
    public enum DGradient: Int, CaseIterable {
        case d2_1
        case d6_4
    }
    
    public static func color(_ kind: DKind10, _ level: DLevel10) -> Color {
