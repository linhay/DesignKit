...
public struct Infinite4Pager<Content: View>: View {
    ...
    public var body: some View {
        ...
        .environment(\.infinite4CurrentPage, CurrentPage(horizontal: currentHorizontalPage, vertical: currentVerticalPage))
    ...
    private func boundedDragOffset(
        ...
        if let totalPages, currentPage == totalPages - 1 {
